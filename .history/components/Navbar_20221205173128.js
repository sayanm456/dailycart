...
const Navbar = ({logout, user, cart, addToCart, removeFromCart, clearCart, subTotal }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-start justify-between items-center mb-1 my-4 shadow-md sticky top-0 bg-white z-10">
      ...
      <div ref={ref} className={`w-72 h-[100vh] sideCart overflow-y-scroll absolute top-0 right-0 bg-violet-100 px-9 py-10 transform transition-transform ${Object.keys(cart).length !== 0 ? 'translate-x-0':'translate-x-full'}`}>
